...
func (in *ResourceTemplate) DeepCopyInto(out *ResourceTemplate) {
	*out = *in
	in.ResourceTemplateSource.DeepCopyInto(&out.ResourceTemplateSource)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceTemplateSource) DeepCopyInto(out *ResourceTemplateSource) {
	*out = *in
	if in.ConfigMap != nil {
	...
	out.PlatformCredentialsSetRef = in.PlatformCredentialsSetRef
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceTemplateSource.
func (in *ResourceTemplateSource) DeepCopy() *ResourceTemplateSource {
	if in == nil {
		return nil
	}
	out := new(ResourceTemplateSource)
	in.DeepCopyInto(out)
	return out
}
