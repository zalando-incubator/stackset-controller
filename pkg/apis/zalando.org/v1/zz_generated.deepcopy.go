...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigResourcesSpec) DeepCopyInto(out *ConfigResourcesSpec) {
	*out = *in
	in.ConfigMapRef.DeepCopyInto(&out.ConfigMapRef)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigResourcesSpec.
func (in *ConfigResourcesSpec) DeepCopy() *ConfigResourcesSpec {
	if in == nil {
		return nil
	}
